...
which_impute = 'DRDQ'
truth_filename = which_impute + '_pairs_truth.csv'
...
impute_file = which_impute + '_pairs_imputation.csv'
...
if which_impute == 'DRDQ':
    ...
    eplet_impute = eplet_dataframe[['DON_ID', 'REC_ID', 'PairProb_' + which_impute, 'DON_' + which_impute, 'REC_' + which_impute, 'DQ_quantity', 'DQ_details']].reset_index(drop=True)  # Only need these columns for now
